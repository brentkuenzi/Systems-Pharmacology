...
def doseResponse(data_file,dose_file,background_row,by_drug = "None", desc=False,lowest0 = True,normalize="lowest"):
	...
	if normalize[0] == "lowest": # normalization method
...
doseResponse(sys.argv[1], sys.argv[2], int(sys.argv[3]), by_drug = sys.argv[4], desc = sys.argv[5], lowest0 = sys.argv[6], normalize=[sys.argv[7],sys.argv[8]])
os.rename("output.txt", sys.argv[9])
